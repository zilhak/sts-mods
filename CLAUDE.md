...
## Game Mechanics Reference - Cheatsheet

**All game-specific information has been moved to the `cheatsheet/` directory for better organization.**

### Quick Reference Guide

Start here: **[cheatsheet/INDEX.md](cheatsheet/INDEX.md)** - Main entry point with full documentation structure

### Finding Information by Topic

#### Monster/Enemy Information
- **Monster names (Korean ↔ English)**: [cheatsheet/ENEMY_LIST.md](cheatsheet/ENEMY_LIST.md)
- **Monster class names, IDs, packages**: [cheatsheet/ENEMY_LIST.md](cheatsheet/ENEMY_LIST.md)
- **Monster attack patterns, move bytes**: [cheatsheet/MONSTER_BEHAVIOR.md](cheatsheet/MONSTER_BEHAVIOR.md)
- **Monster AI decision system**: [cheatsheet/MONSTER_AI_SYSTEM.md](cheatsheet/MONSTER_AI_SYSTEM.md)

#### Modifying Game Elements
- **Monster health modification**: [cheatsheet/MONSTER_HEALTH.md](cheatsheet/MONSTER_HEALTH.md)
- **Monster damage modification**: [cheatsheet/MONSTER_DAMAGE.md](cheatsheet/MONSTER_DAMAGE.md)
- **Monster behavior patterns**: [cheatsheet/MONSTER_BEHAVIOR.md](cheatsheet/MONSTER_BEHAVIOR.md)
- **Enemy modification guide**: [cheatsheet/ENEMY_MODIFY.md](cheatsheet/ENEMY_MODIFY.md)

#### Game Systems
- **Card reward probabilities**: [cheatsheet/CARD_REWARD_SYSTEM.md](cheatsheet/CARD_REWARD_SYSTEM.md)
- **Relic and potion systems**: [cheatsheet/RELIC_POTION_SYSTEM.md](cheatsheet/RELIC_POTION_SYSTEM.md)
- **Monster AI patterns**: [cheatsheet/MONSTER_AI_SYSTEM.md](cheatsheet/MONSTER_AI_SYSTEM.md)

#### Modding Basics
- **SpirePatch fundamentals**: [cheatsheet/PATCH_BASICS.md](cheatsheet/PATCH_BASICS.md)
- **Common patterns**: [cheatsheet/COMMON_PATTERNS.md](cheatsheet/COMMON_PATTERNS.md)
- **Implementation examples**: [cheatsheet/IMPLEMENTATION_STATUS.md](cheatsheet/IMPLEMENTATION_STATUS.md)

### Power/Buff/Debuff Classes
For power class names (e.g., `StrengthPower`, `VulnerablePower`, `ThornsPower`):
- See [cheatsheet/MONSTER_BEHAVIOR.md](cheatsheet/MONSTER_BEHAVIOR.md) - Contains buff/debuff modification examples

### Additional Resources
- **Decompiled source**: `E:\workspace\sts-decompile\`
- **Implementation reference**: `ascension-100/src/main/java/com/stsmod/ascension100/patches/`
