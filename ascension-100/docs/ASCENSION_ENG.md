# Ascension Levels Detail (English)

Detailed gameplay effects for Slay the Spire Ascension levels 21-100.

## Levels 1-20 (Base Game)
Base game ascension effects apply unchanged.
...
## Level 23: Elite Attack Enhancement
**Effect**: Elite enemies' attacks are enhanced.
...
- Taskmaster: Damage +3
- Giant Head: "It Is Time" damage +10
- Nemesis: Damage +5
...
## Level 26: Enemy Pattern Enhancement
**Effect**: Enemy behavior patterns are enhanced.

**Details**:
- Louse (LouseNormal/LouseDefensive): Curl Up +3
- Slimes (AcidSlime/SpikeSlime): Attack patterns add +1 Slimed
- Looter: Thievery +5
- Jaw Worm (JawWorm): Gain Block +3 when gaining Strength
...
- Byrd: Caw Strength +1
- Chosen: Damage +2
- Centurion: Defend Block +5
- Healer: When alone, gain Strength +2 and heal 10% HP per turn
- Snecko: Damage +2
...
- Giant Head: HP +100%, Slow effect changed (25% damage increase per card played)

---

## Level 27: Boss Stat Enhancement
**Effect**: Boss stats are enhanced.

**Details**:
- Slime Boss: HP +10
- The Guardian: HP +20
- Hexaghost: HP +20
- Bronze Automaton: Damage +2, HP +20, Artifact +1
- The Champ: Damage +2
- The Collector: HP +40
- Awakened One: HP +30
- Time Eater: HP +40
- Donu & Deca: HP +35 each
- Corrupt Heart: HP +50

---

## Level 28: Boss Pattern Enhancement
**Effect**: Boss behavior patterns are enhanced.

**Details**:
- Slime Boss: Goop Spray Slimed +1
- The Guardian: Vent Steam Weak/Vulnerable +1
- Hexaghost: Inferno Strength +1
- Bronze Automaton: Bronze Orb HP +20
- The Champ: Gloat Strength +1
...
## Level 31: Artifact Monster Enhancement
**Effect**: Monsters starting with Artifact gain +1 Artifact.
...
## Level 65: Artifact Monster Additional Enhancement
**Effect**: Monsters starting with Artifact gain additional +1 Artifact. (Stacks with Level 31)
