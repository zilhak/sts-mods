...
/**
 * Ascension Level 36: Elite enemies attack enhancements
 *
 * 엘리트 적들의 공격이 강화됩니다.
 *
...
public class Level36 {
    ...
    public static class GremlinNobDamagePatch {
        ...
        public static void Postfix(GremlinNob __instance) {
            ...
            logger.info("Ascension 36: Gremlin Nob damage +1");
        }
    }
    ...
    public static class LagavulinDamagePatch {
        ...
        public static void Postfix(Lagavulin __instance) {
            ...
            logger.info("Ascension 36: Lagavulin damage +1");
        }
    }
    ...
    public static class SentryDamagePatch {
        ...
        public static void Postfix(Sentry __instance) {
            ...
            logger.info("Ascension 36: Sentry damage +1");
        }
    }
    ...
    public static class BookOfStabbingDamagePatch {
        ...
        public static void Postfix(BookOfStabbing __instance) {
            ...
            logger.info("Ascension 36: Book of Stabbing damage +1");
        }
    }
    ...
    public static class TaskmasterDamagePatch {
        ...
        public static void Postfix(Taskmaster __instance) {
            ...
            logger.info("Ascension 36: Taskmaster damage +2");
        }
    }
    ...
    public static class GiantHeadDamagePatch {
        ...
        public static void Postfix(GiantHead __instance) {
            ...
            try {
                ...
                logger.info("Ascension 36: Giant Head IT IS TIME damage +5 (damage[1-7] + startingDeathDmg)");
            } catch (Exception e) {
        ...
        public static void Postfix(GiantHead __instance, int num) {
            ...
            try {
                ...
                if (nextMove == 2) { // IT_IS_TIME
                    ...
                    logger.info(String.format("Ascension 36: Giant Head IT IS TIME Intent updated to %d (count=%d, index=%d)",
    ...
    public static class NemesisDamagePatch {
        ...
        public static void Postfix(Nemesis __instance) {
            ...
            try {
                ...
                logger.info(String.format("Ascension 36: Nemesis damage +2 (Scythe: %d, Burns: %d)",
    ...
    public static class ReptomancerDamagePatch {
        ...
        public static void Postfix(Reptomancer __instance) {
            ...
            logger.info("Ascension 36: Reptomancer damage +2");
        }
    }
        ...
        public static void Postfix(GremlinLeader __instance) {
            ...
            try {
                ...
                if (nextMove == 3) { // Encourage move
                    ...
                    logger.info("Ascension 36: Gremlin Leader Encourage +1 Strength to minions");
                }
            } catch (Exception e) {
